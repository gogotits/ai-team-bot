...
from .tools import fact_checker_tools # Импортируем команду из соседнего файла
...
- `CurrencyExchangeTool`: Специалист по курсам валют.
...
# Создаем stateless-агента (без памяти диалога)
