...
def create_excel_document(content: str) -> str:
    ...
    for line in content.split('\n'):
        # Предполагаем, что ячейки в строке разделены запятой
...
5.  Инструменты для создания документов используй только тогда, когда пользователь прямо попросил об этом.
"""
